...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.colorAshen));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.colorAshen));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.colorBlack));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.colorBlack));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.colorAshen));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.colorAshen));
        }
    }
